...
const Map<String, String> _signin_screen  = {
  ...
  signin_screen.signin_title: "SIGN IN TO NEXT MATCH",
  signin_screen.signin_sub_title: "Welcome back to Next Match",
...
const Map<String, String> _forget_password_screen  = {
  forget_password_screen.forget_password: "Forget Password",
